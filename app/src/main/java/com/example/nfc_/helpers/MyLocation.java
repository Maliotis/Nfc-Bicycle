...
public class MyLocation {
        ...
        public void onGpsStatusChanged(int event) {
            ...
            if (event == GpsStatus.GPS_EVENT_SATELLITE_STATUS) {
                try {
                    ...
                    @SuppressLint("MissingPermission") GpsStatus status = myLocationManager.getGpsStatus(null);
    ...
    public static Location getLocation(Context context) {
        ...
        try {
            ...
            @SuppressLint("MissingPermission") Location location = lm.getLastKnownLocation(strLocationProvider);
            if (location != null) {
                return location;
            }
            return null;
